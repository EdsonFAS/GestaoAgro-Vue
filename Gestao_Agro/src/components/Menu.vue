<template>
  <nav class="bg-green-700 text-white w-40 lg:w-52 min-h-screen p-6 fixed left-0 top-0 shadow-lg flex flex-col">
    ...
    <div class="flex-1 flex flex-col justify-between">
      ...
      <button
        @click="handleLogout"
        class="mt-8 flex items-center gap-2 p-3 rounded-lg hover:bg-green-900 transition text-left font-bold text-[16px]"
      >
